...
switch = {
    ...
    "port": 22,
    "timeout": 60,  # longer timeout for DevNet
}

# VLANs we want to create and verify
vlans_to_create = {
    110: "User_Network",
    120: "ACCT_Network",
    130: "MGMT_Network",
...
for attempt in range(1, max_retries + 1):
    try:
        ...
        # 2️⃣ Create VLANs that don’t exist and confirm creation
